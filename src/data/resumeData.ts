...
export const skills: SkillCategory[] = [
  ...
  {
    category: "Databases",
    items: ["PostgreSQL", "Azure Cosmos DB", "Elasticsearch", "SQLite", "SAP HANA"]
  }
];
...
export const education: EducationItem[] = [
  ...
  },
  {
    ...
    degree: "Bachelors of Technology in Electronics & Telecommunications Engineering",
